...
import com.universl.ryan.englandweather.utils.CommonUtils;
...
//            imageView.setImageResource(R.drawable.wallpaper_3);
            if (sdk < android.os.Build.VERSION_CODES.JELLY_BEAN) {
                appView.setBackgroundDrawable(ContextCompat.getDrawable(this, R.drawable.weather_splash));
            } else {
                appView.setBackground(ContextCompat.getDrawable(this, R.drawable.weather_splash));
            }
        } else if (i == 2) {
//            imageView.setScaleType(ImageView.ScaleType.CENTER_CROP);
//            imageView.setImageResource(R.drawable.wallpaper_3);
...
//            imageView.setImageResource(R.drawable.wallpaper_3);
    ...
    public void dataAlert() {
        ...
        dialogBuilder.setIcon(R.mipmap.ic_launcher_foreground);
